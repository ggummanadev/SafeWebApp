    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-900">최신등록 웹앱 및 웹사이트</h2>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start mb-8">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider shadow-sm">
